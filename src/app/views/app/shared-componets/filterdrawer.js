...
const filter_loading = channel_loading && country_loading && category_loading && brand_loading && priority_loading && publisher_loading && status_loading ? true : false
  ...
  const handleSubmit = (e) => {
    ...
    const data = {
      ...
      country:
        ...
        selectedFilters?.country.length == getCountry.length
          ? "all"
      ...
      category:
        ...
        selectedFilters?.category.length == getCategory.length
          ? "all"
      ...
      publisher:
        ...
        selectedFilters?.publisher.length == getPublisher.length
          ? "all"
      ...
      channel:
        ...
        selectedFilters?.channel.length == getChannel.length
      ...
      brand:
        ...
        selectedFilters?.brand.length == getBrand.length
          ? "all"
      ...
      status:
        ...
        selectedFilters?.status.length == getStatus.length
          ? "all"
      ...
      priority:
        ...
        selectedFilters?.priority.length == getPriorities.length
          ? "all"
              ...
              <Form>
                ...
                <Col xs={12} sm={12} md={12} lg={12} xl={12}>
                  <Button
                    ...
                    className="btn btn-primary font-weight-bolder font-size-sm mr-3 custom-button w-100"
...
const mapStateToProps = (state) => {
  ...
  return {
    ...
    channel_loading: common && common.channel_loading ? common.channel_loading : false,
    country_loading: common && common.country_loading ? common.country_loading : false,
    category_loading: common && common.category_loading ? common.category_loading : false,
    brand_loading: common && common.brand_loading ? common.brand_loading : false,
    priority_loading: common && common.priority_loading ? common.priority_loading : false,
    publisher_loading: common && common.publisher_loading ? common.publisher_loading : false,
    status_loading: common && common.status_loading ? common.status_loading : false,
    filter_list: common && common.filter_list ? common.filter_list : false,
    setGlobalRefreshRendering:
